...
if __name__ == "__main__":
    ...
    #Test if compare_frames function works

    #frame1 = cv2.imread('Lenna50.jpg')
    #frame2 = cv2.imread('Lenna100.jpg')
    #print(compare_frames(Image.fromarray(frame1) , Image.fromarray(frame2) ))
